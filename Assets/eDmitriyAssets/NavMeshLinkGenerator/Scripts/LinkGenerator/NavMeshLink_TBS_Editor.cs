...
namespace UnityEditor.AI
{
    ...
    [CustomEditor ( typeof ( NavMeshLink_TBS ) )]
    class NavMeshLink_TBS_Editor : Editor
    {
#if UNITY_EDITOR
        SerializedProperty animation_FromStart;
        SerializedProperty animation_FromEnd;
        ...
        void OnEnable ()
        {
            animation_FromStart = serializedObject.FindProperty ( "animation_FromStart" );
            animation_FromEnd = serializedObject.FindProperty ( "animation_FromEnd" );
        ...
        public override void OnInspectorGUI ()
        {
            ...
            //EditorGUILayout.HelpBox ( "TurnBased OffMeshLinkData", MessageType.Info );

            EditorGUILayout.PropertyField ( animation_FromStart );
            EditorGUILayout.PropertyField ( animation_FromEnd );
